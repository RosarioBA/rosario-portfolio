...
const projects = [
  ...
  },
  {
    ...
    description: "Rebuilt the Subud World Association's WordPress site using Next.js 15 and Sanity CMS — my first headless CMS project, built as part of a team.",
    tech: ["Next.js 15", "Sanity CMS", "TypeScript", "pnpm Monorepo"],
    type: "Team Project",
    side: "left",
    live: "https://subud.org/",
    caseStudy: "/projects/subud",
  },
  {
    id: "bonita-receipt",
